...
//		Log.d(TAG, "Sreen resolution: " + screenResolution);
		Point screenResolutionForCamera = new Point();
		screenResolutionForCamera.x = screenResolution.x;
		screenResolutionForCamera.y = screenResolution.y; // preview size is
															// always something
															// like 480*320,
															// other 320*480
...
//		Log.d(TAG, "Camera resolution: " + screenResolution);
	 ...
	 * and com.slwl.slwlproject.decoding. We detect the preview format here so that
