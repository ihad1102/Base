...
package com.yj.baselibrary.qrcode.camera;
 ...
 * preview-sized images, which are used for both preview and com.slwl.slwlproject.decoding.
 *
 */
public final class CameraManager {
	...
	public static void init(Context context, Activity activity) {
		if (cameraManager == null) {
			...
			int weight = screenInfo.getWidth();
			MIN_FRAME_WIDTH = screenInfo.MinWidth(weight);
			MIN_FRAME_HEIGHT = screenInfo.MinWidth(weight);
			MAX_FRAME_WIDTH = screenInfo.MaxWidth(weight);
			MAX_FRAME_HEIGHT = screenInfo.MaxWidth(weight);
