package com.yj.baselibrary.widget.Rating;
 ...
 */
public class NiceRatingEditBar extends LinearLayout {
    ...
    public NiceRatingEditBar(Context context) {
        this(context, null);
    }

    public NiceRatingEditBar(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public NiceRatingEditBar(Context context, AttributeSet attrs, int defStyleAttr) {
