 ...
 * 社区营造
 */
public class CommunityBuildingActivity extends BaseActivity implements  View.OnClickListener {
    private TextView tb_tv_title;
    private ImageView iv_left;
    @Override
    public int getLayoutId() {
        return R.layout.activity_community_building;
    }
